...
public class WDskLMemRMemTest {
	...
	// Write to disk and read from disk
	@Test
	public void testWDskLMemRMem() {
		...
		OBuffer testDataset = drm._manageNewDataReferenceBackupOnDisk(dataRef);
