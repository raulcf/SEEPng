...
public class NoSpaceToWMem_so_WDskRDskTest {
	...
	private WorkerConfig buildWorkerConfig() {
		...
		final int maxBufferSize = (numTuples-3) * tupleSize;
		final int minBufferAllocation = (numTuples) * tupleSize;
	...
	@Test
	public void testNoSpaceToWMem_so_WDskRDskTest() {
