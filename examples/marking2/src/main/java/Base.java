...
//	int scaleFactor = 10;
	...
	public SeepLogicalQuery compose() {
        ...
        String inPath =
"/Users/ra-mit/development/SEEPng/examples/marking2/data/clair_30m.out";
//        String inPath =
//"/Users/ra/Development/SEEPng/examples/marking/data/clair_30m.out";
        ...
        String outPath =
"/Users/ra-mit/development/SEEPng/examples/marking2/data/clair_30m_results.out";
//        String outPath =
...
//		"/home/matthias/repos/15-MDF-usecase/applications/simple-event-marking-query/data/clair_30m_results.out";
		...
		String markingQueryTemplate = 
			"Select first(timestamp) as start_timestamp, last(timestamp) as end_timestamp, well, injector, max(BHP)-min(BHP) as magnitude " + 
...
//		}
//	//	markingChoose.connectTo(snk, flowId++, new DataStore(markedSchema, DataStoreType.NETWORK));
//
